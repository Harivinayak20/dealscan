        ...
        <section className="grid gap-4">
          ...
          >
            <div className="flex items-start gap-4">
              <span className="grid h-12 w-12 place-items-center rounded-xl bg-[rgba(18,61,51,0.08)] text-[var(--racing-green)] transition group-hover:bg-[var(--racing-green)] group-hover:text-white">
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-6">
            <div className="flex items-start gap-4">
              <span className="grid h-12 w-12 place-items-center rounded-xl bg-[rgba(18,61,51,0.08)] text-[var(--racing-green)]">
