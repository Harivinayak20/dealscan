...
export function AdUnit({ slot, className = "" }: AdUnitProps) {
  ...
  return (
    <aside
      ...
      className={`mx-auto w-full max-w-[970px] rounded-xl border border-[var(--line)] bg-[var(--paper)] p-3 text-[var(--graphite)] shadow-[inset_0_1px_0_rgba(255,255,255,0.64)] ${className}`}
    >
